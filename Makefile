...
oapi-codegen-rbac: oapi-codegen # @HELP generate openapi types from rbac-1.0.0-openapi3.yaml
	...
	sed -i "s/target Target/target types.Target/g" pkg/rbac_1_0_0/server/rbac-1.0.0-impl.go
	oapi-codegen \
		-generate server \
	...
	oapi-codegen \
		...
		api/rbac-1.0.0-openapi3.yaml
	sed -i "s/target Target/target types.Target/g" pkg/rbac_1_0_0/server/rbac-1.0.0-server.go
	for f in pkg/rbac_1_0_0/**/rbac-1.0.0*.go; do sed -i '1i// Code generated by oapi-codegen. DO NOT EDIT.' $$f; done

oapi-codegen-aether-2.0.0: oapi-codegen # @HELP generate openapi types from aether-2.0.0-openapi3.yaml
