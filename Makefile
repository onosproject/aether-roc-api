...
oapi-codegen-aether: # @HELP generate openapi types from aether-1.0.0-openapi3.yaml
	...
	oapi-codegen -generate server -package aether_1_0_0 -o pkg/aether_1_0_0/aether-1.0.0-server.go api/aether-1.0.0-openapi3.yaml
...
oapi-codegen-rbac: # @HELP generate openapi types from rbac-1.0.0-openapi3.yaml
	...
	oapi-codegen -generate server -package rbac_1_0_0 -o pkg/rbac_1_0_0/rbac-1.0.0-server.go api/rbac-1.0.0-openapi3.yaml
