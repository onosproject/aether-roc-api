...
oapi-codegen-aether-1.0.0: oapi-codegen # @HELP generate openapi types from aether-1.0.0-openapi3.yaml
...
oapi-codegen-aether-2.0.0: oapi-codegen
	...
	sed -i "s/target Target/target types.Target/g" pkg/aether_2_0_0/server/aether-2.0.0-server.go
	...
	sed -i "s/target Target/target types.Target/g" pkg/aether_2_0_0/server/aether-2.0.0-impl.go
...
aether-top-level: oapi-codegen # @HELP generate openapi types from aether-top-level-openapi3.yaml
	...
	oapi-codegen -generate server -package server -templates pkg/codegen/templates \
	-import-mapping \
	./aether-2.0.0-openapi3.yaml:github.com/onosproject/aether-roc-api/pkg/aether_2_0_0/types,\
	./rbac-1.0.0-openapi3.yaml:github.com/onosproject/aether-roc-api/pkg/rbac_1_0_0/types \
	-o pkg/toplevel/server/toplevel-impl.go api/aether-top-level-openapi3.yaml
	sed -i "s/Target/types.Target/g" pkg/toplevel/server/toplevel-impl.go

	oapi-codegen -generate server -package server -templates pkg/codegen/modified \
	-import-mapping \
	./aether-2.0.0-openapi3.yaml:github.com/onosproject/aether-roc-api/pkg/aether_2_0_0/types,\
	./rbac-1.0.0-openapi3.yaml:github.com/onosproject/aether-roc-api/pkg/rbac_1_0_0/types \
	-o pkg/toplevel/server/toplevel-server.go api/aether-top-level-openapi3.yaml
	...
	sed -i "s/model_0_0_0/toplevel/g" pkg/toplevel/*/*.go
	sed -i "s/model-0.0.0/toplevel/g" pkg/toplevel/*/*.go
	for f in pkg/toplevel/**/toplevel*.go; do sed -i '1i// Code generated by oapi-codegen. DO NOT EDIT.' $$f; done
