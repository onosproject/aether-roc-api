...
oapi-codegen-aether-2.0.0: oapi-codegen
	...
	sed -e "s/target Target/target externalRef1.Target/g" pkg/aether_2_0_0/server/aether-2.0.0-impl.go > aether-2.0.0-impl.new
	mv aether-2.0.0-impl.new pkg/aether_2_0_0/server/aether-2.0.0-impl.go
	oapi-codegen \
		-generate server \
		...
		api/aether-2.0.0-openapi3.yaml
	sed -e "s/target Target/target externalRef0.Target/g" pkg/aether_2_0_0/server/aether-2.0.0-server.go > aether-2.0.0-server.new
	mv aether-2.0.0-server.new pkg/aether_2_0_0/server/aether-2.0.0-server.go
	oapi-codegen \
		-generate types \
	...
	mv aether-2.0.0-convert-oapi-gnmi.new pkg/aether_2_0_0/server/aether-2.0.0-convert-oapi-gnmi.go
	oapi-codegen \
		-generate types \
		-import-mapping externalRef0:"github.com/onosproject/aether-models/models/aether-2.0.x/v2/api" \
		-package server \
