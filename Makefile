...
oapi-codegen-aether-3.0.0: # @HELP generate openapi types from aether-3.0.0-openapi3.yaml
oapi-codegen-aether-3.0.0: oapi-codegen
	mkdir -p pkg/aether_3_0_0/types pkg/aether_3_0_0/server
	oapi-codegen -generate types -package types -o pkg/aether_3_0_0/types/aether-3.0.0-types.go api/aether-3.0.0-openapi3.yaml
	oapi-codegen -generate spec -package server -o pkg/aether_3_0_0/server/aether-3.0.0-spec.go api/aether-3.0.0-openapi3.yaml
	oapi-codegen \
		-generate types,server \
		-import-mapping externalRef0:"github.com/onosproject/aether-roc-api/pkg/aether_3_0_0/types",externalRef1:"github.com/onosproject/config-models/modelplugin/aether-3.0.0/aether_3_0_0" \
		-package server \
		-templates pkg/codegen/templates \
		-o pkg/aether_3_0_0/server/aether-3.0.0-impl.go \
		api/aether-3.0.0-openapi3.yaml
	sed -i "s/target Target/target externalRef0.Target/g" pkg/aether_3_0_0/server/aether-3.0.0-impl.go
	oapi-codegen \
		-generate server \
		-import-mapping externalRef0:"github.com/onosproject/aether-roc-api/pkg/aether_3_0_0/types" \
		-package server \
		-templates pkg/codegen/modified \
		-o pkg/aether_3_0_0/server/aether-3.0.0-server.go \
		api/aether-3.0.0-openapi3.yaml
	sed -i "s/target Target/target externalRef0.Target/g" pkg/aether_3_0_0/server/aether-3.0.0-server.go
	oapi-codegen \
		-generate types \
		-import-mapping externalRef0:"github.com/onosproject/config-models/modelplugin/aether-3.0.0/aether_3_0_0" \
		-package server \
		-templates pkg/codegen/convert-oapi-gnmi \
		-o pkg/aether_3_0_0/server/aether-3.0.0-convert-oapi-gnmi.go \
		api/aether-3.0.0-openapi3.yaml
	oapi-codegen \
		-generate types \
		-import-mapping externalRef0:"github.com/onosproject/config-models/modelplugin/aether-3.0.0/aether_3_0_0" \
		-package server \
		-templates pkg/codegen/convert-gnmi-oapi \
		-o pkg/aether_3_0_0/server/aether-3.0.0-convert-gnmi-oapi.go \
		api/aether-3.0.0-openapi3.yaml
	for f in pkg/aether_3_0_0/**/aether-3.0.0*.go; do sed -i '1i// Code generated by oapi-codegen. DO NOT EDIT.' $$f; done
...
aether-top-level: oapi-codegen
	...
	./aether-3.0.0-openapi3.yaml:github.com/onosproject/aether-roc-api/pkg/aether_3_0_0/types \
...
generated: oapi-codegen-aether-2.1.0 oapi-codegen-aether-3.0.0 oapi-codegen-aether-4.0.0
...
clean-generated: # @HELP remove generated artifacts
	...
	rm -f pkg/aether_3_0_0/**/aether-3.0.0*.go
	rm -f pkg/aether_3_0_0/**/aether-4.0.0*.go
