...
type ServerInterface interface {
	...
	// DELETE Generated from YANG model
	// (DELETE /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi)
	DeleteSubscriberUeImsi(ctx echo.Context, target types.Target, id string) error
	// GET /subscriber/ue/{id}/imsi Generated from YANG model
	// (GET /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi)
	GetSubscriberUeImsi(ctx echo.Context, target types.Target, id string) error
	// POST Generated from YANG model
	// (POST /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi)
	PostSubscriberUeImsi(ctx echo.Context, target types.Target, id string) error
	// DELETE Generated from YANG model
	// (DELETE /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range)
	DeleteSubscriberUeImsiRange(ctx echo.Context, target types.Target, id string) error
	// GET /subscriber/ue/{id}/imsi/range Generated from YANG model
	// (GET /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range)
	GetSubscriberUeImsiRange(ctx echo.Context, target types.Target, id string) error
	// POST Generated from YANG model
	// (POST /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range)
	PostSubscriberUeImsiRange(ctx echo.Context, target types.Target, id string) error
	// DELETE Generated from YANG model
	// (DELETE /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard)
	DeleteSubscriberUeImsiWildcard(ctx echo.Context, target types.Target, id string) error
	// GET /subscriber/ue/{id}/imsi/wildcard Generated from YANG model
	// (GET /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard)
	GetSubscriberUeImsiWildcard(ctx echo.Context, target types.Target, id string) error
	// POST Generated from YANG model
	// (POST /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard)
	PostSubscriberUeImsiWildcard(ctx echo.Context, target types.Target, id string) error
	// DELETE Generated from YANG model
...
// DeleteSubscriberUeImsi converts echo context to params.
func (w *ServerInterfaceWrapper) DeleteSubscriberUeImsi(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.DeleteSubscriberUeImsi(ctx, target, id)
	return err
}

// GetSubscriberUeImsi converts echo context to params.
func (w *ServerInterfaceWrapper) GetSubscriberUeImsi(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GetSubscriberUeImsi(ctx, target, id)
	return err
}

// PostSubscriberUeImsi converts echo context to params.
func (w *ServerInterfaceWrapper) PostSubscriberUeImsi(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.PostSubscriberUeImsi(ctx, target, id)
	return err
}

// DeleteSubscriberUeImsiRange converts echo context to params.
func (w *ServerInterfaceWrapper) DeleteSubscriberUeImsiRange(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.DeleteSubscriberUeImsiRange(ctx, target, id)
	return err
}

// GetSubscriberUeImsiRange converts echo context to params.
func (w *ServerInterfaceWrapper) GetSubscriberUeImsiRange(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GetSubscriberUeImsiRange(ctx, target, id)
	return err
}

// PostSubscriberUeImsiRange converts echo context to params.
func (w *ServerInterfaceWrapper) PostSubscriberUeImsiRange(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.PostSubscriberUeImsiRange(ctx, target, id)
	return err
}

// DeleteSubscriberUeImsiWildcard converts echo context to params.
func (w *ServerInterfaceWrapper) DeleteSubscriberUeImsiWildcard(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.DeleteSubscriberUeImsiWildcard(ctx, target, id)
	return err
}

// GetSubscriberUeImsiWildcard converts echo context to params.
func (w *ServerInterfaceWrapper) GetSubscriberUeImsiWildcard(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GetSubscriberUeImsiWildcard(ctx, target, id)
	return err
}

// PostSubscriberUeImsiWildcard converts echo context to params.
func (w *ServerInterfaceWrapper) PostSubscriberUeImsiWildcard(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "target" -------------
	var target types.Target
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.PostSubscriberUeImsiWildcard(ctx, target, id)
	return err
}
...
func RegisterHandlers(router EchoRouter, si ServerInterface) {
	...
	router.DELETE("/aether/v2.0.0/:target/subscriber/ue/:id/imsi", wrapper.DeleteSubscriberUeImsi)
	router.GET("/aether/v2.0.0/:target/subscriber/ue/:id/imsi", wrapper.GetSubscriberUeImsi)
	router.POST("/aether/v2.0.0/:target/subscriber/ue/:id/imsi", wrapper.PostSubscriberUeImsi)
	router.DELETE("/aether/v2.0.0/:target/subscriber/ue/:id/imsi/range", wrapper.DeleteSubscriberUeImsiRange)
	router.GET("/aether/v2.0.0/:target/subscriber/ue/:id/imsi/range", wrapper.GetSubscriberUeImsiRange)
	router.POST("/aether/v2.0.0/:target/subscriber/ue/:id/imsi/range", wrapper.PostSubscriberUeImsiRange)
	router.DELETE("/aether/v2.0.0/:target/subscriber/ue/:id/imsi/wildcard", wrapper.DeleteSubscriberUeImsiWildcard)
	router.GET("/aether/v2.0.0/:target/subscriber/ue/:id/imsi/wildcard", wrapper.GetSubscriberUeImsiWildcard)
	router.POST("/aether/v2.0.0/:target/subscriber/ue/:id/imsi/wildcard", wrapper.PostSubscriberUeImsiWildcard)
