...
// gnmiDeleteSubscriberUeImsi deletes an instance of Subscriber_Ue_Imsi.
func (i *ServerImpl) gnmiDeleteSubscriberUeImsi(ctx context.Context,
	openApiPath string, target types.Target, args ...string) error {
...
// gnmiGetSubscriberUeImsi returns an instance of Subscriber_Ue_Imsi.
func (i *ServerImpl) gnmiGetSubscriberUeImsi(ctx context.Context,
	openApiPath string, target types.Target, args ...string) (*types.SubscriberUeImsi, error) {
	...
	return mpd.toSubscriberUeImsi(args...)
}

// gnmiPostSubscriberUeImsi adds an instance of Subscriber_Ue_Imsi.
func (i *ServerImpl) gnmiPostSubscriberUeImsi(ctx context.Context, body []byte,
	openApiPath string, target types.Target, args ...string) (*string, error) {

	jsonObj := new(types.SubscriberUeImsi)
	if err := json.Unmarshal(body, jsonObj); err != nil {
		return nil, fmt.Errorf("unable to unmarshal JSON as types.Subscriber_Ue_Imsi %v", err)
	}
	gnmiUpdates, err := encodeToGnmiSubscriberUeImsi(jsonObj, false, "", args...)
	if err != nil {
		return nil, fmt.Errorf("unable to convert types.SubscriberUeImsi to gNMI %v", err)
	}
	gnmiSet, err := utils.NewGnmiSetUpdateRequestUpdates(openApiPath, string(target), gnmiUpdates, args...)
	if err != nil {
		return nil, err
...
// gnmiDeleteSubscriberUeImsiRange deletes an instance of Subscriber_Ue_Imsi_Range.
func (i *ServerImpl) gnmiDeleteSubscriberUeImsiRange(ctx context.Context,
	openApiPath string, target types.Target, args ...string) error {
...
// gnmiGetSubscriberUeImsiRange returns an instance of Subscriber_Ue_Imsi_Range.
func (i *ServerImpl) gnmiGetSubscriberUeImsiRange(ctx context.Context,
	openApiPath string, target types.Target, args ...string) (*types.SubscriberUeImsiRange, error) {
	...
	return mpd.toSubscriberUeImsiRange(args...)
}

// gnmiPostSubscriberUeImsiRange adds an instance of Subscriber_Ue_Imsi_Range.
func (i *ServerImpl) gnmiPostSubscriberUeImsiRange(ctx context.Context, body []byte,
	openApiPath string, target types.Target, args ...string) (*string, error) {

	jsonObj := new(types.SubscriberUeImsiRange)
	if err := json.Unmarshal(body, jsonObj); err != nil {
		return nil, fmt.Errorf("unable to unmarshal JSON as types.Subscriber_Ue_Imsi_Range %v", err)
	}
	gnmiUpdates, err := encodeToGnmiSubscriberUeImsiRange(jsonObj, false, "", args...)
	if err != nil {
		return nil, fmt.Errorf("unable to convert types.SubscriberUeImsiRange to gNMI %v", err)
	}
	gnmiSet, err := utils.NewGnmiSetUpdateRequestUpdates(openApiPath, string(target), gnmiUpdates, args...)
	if err != nil {
		return nil, err
...
// gnmiDeleteSubscriberUeImsiWildcard deletes an instance of Subscriber_Ue_Imsi_Wildcard.
func (i *ServerImpl) gnmiDeleteSubscriberUeImsiWildcard(ctx context.Context,
	openApiPath string, target types.Target, args ...string) error {
...
// gnmiGetSubscriberUeImsiWildcard returns an instance of Subscriber_Ue_Imsi_Wildcard.
func (i *ServerImpl) gnmiGetSubscriberUeImsiWildcard(ctx context.Context,
	openApiPath string, target types.Target, args ...string) (*types.SubscriberUeImsiWildcard, error) {
	...
	return mpd.toSubscriberUeImsiWildcard(args...)
}

// gnmiPostSubscriberUeImsiWildcard adds an instance of Subscriber_Ue_Imsi_Wildcard.
func (i *ServerImpl) gnmiPostSubscriberUeImsiWildcard(ctx context.Context, body []byte,
	openApiPath string, target types.Target, args ...string) (*string, error) {

	jsonObj := new(types.SubscriberUeImsiWildcard)
	if err := json.Unmarshal(body, jsonObj); err != nil {
		return nil, fmt.Errorf("unable to unmarshal JSON as types.Subscriber_Ue_Imsi_Wildcard %v", err)
	}
	gnmiUpdates, err := encodeToGnmiSubscriberUeImsiWildcard(jsonObj, false, "", args...)
	if err != nil {
		return nil, fmt.Errorf("unable to convert types.SubscriberUeImsiWildcard to gNMI %v", err)
	}
	gnmiSet, err := utils.NewGnmiSetUpdateRequestUpdates(openApiPath, string(target), gnmiUpdates, args...)
	if err != nil {
		return nil, err
...
type Translator interface {
	...
	toSubscriberUeImsi(args ...string) (*types.SubscriberUeImsi, error)
	toSubscriberUeImsiRange(args ...string) (*types.SubscriberUeImsiRange, error)
	toSubscriberUeImsiWildcard(args ...string) (*types.SubscriberUeImsiWildcard, error)
