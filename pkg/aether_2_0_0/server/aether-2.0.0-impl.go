...
// DeleteSubscriberUeImsi impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi
func (i *ServerImpl) DeleteSubscriberUeImsi(ctx echo.Context, target types.Target, id string) error {

	var response interface{}
	var err error

	// Response
	err = i.gnmiDeleteSubscriberUeImsi(context.Background(), "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi", target, id)
	...
	log.Infof("DeleteSubscriberUeImsi")
	return ctx.JSON(http.StatusOK, response)
}

// GetSubscriberUeImsi impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi
func (i *ServerImpl) GetSubscriberUeImsi(ctx echo.Context, target types.Target, id string) error {

	var response interface{}
	var err error

	// Response GET OK 200
	response, err = i.gnmiGetSubscriberUeImsi(context.Background(), "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi", target, id)
	...
	log.Infof("GetSubscriberUeImsi")
	return ctx.JSON(http.StatusOK, response)
}

// PostSubscriberUeImsi impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi
func (i *ServerImpl) PostSubscriberUeImsi(ctx echo.Context, target types.Target, id string) error {
	...
	extension100, err := i.gnmiPostSubscriberUeImsi(context.Background(), body, "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
	...
	log.Infof("PostSubscriberUeImsi")
	return ctx.JSON(http.StatusOK, response)
}

// DeleteSubscriberUeImsiRange impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range
func (i *ServerImpl) DeleteSubscriberUeImsiRange(ctx echo.Context, target types.Target, id string) error {

	var response interface{}
	var err error

	// Response
	err = i.gnmiDeleteSubscriberUeImsiRange(context.Background(), "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range", target, id)
	...
	log.Infof("DeleteSubscriberUeImsiRange")
	return ctx.JSON(http.StatusOK, response)
}

// GetSubscriberUeImsiRange impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range
func (i *ServerImpl) GetSubscriberUeImsiRange(ctx echo.Context, target types.Target, id string) error {

	var response interface{}
	var err error

	// Response GET OK 200
	response, err = i.gnmiGetSubscriberUeImsiRange(context.Background(), "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range", target, id)
	...
	log.Infof("GetSubscriberUeImsiRange")
	return ctx.JSON(http.StatusOK, response)
}

// PostSubscriberUeImsiRange impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range
func (i *ServerImpl) PostSubscriberUeImsiRange(ctx echo.Context, target types.Target, id string) error {
	...
	extension100, err := i.gnmiPostSubscriberUeImsiRange(context.Background(), body, "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/range", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
	...
	log.Infof("PostSubscriberUeImsiRange")
	return ctx.JSON(http.StatusOK, response)
}

// DeleteSubscriberUeImsiWildcard impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard
func (i *ServerImpl) DeleteSubscriberUeImsiWildcard(ctx echo.Context, target types.Target, id string) error {

	var response interface{}
	var err error

	// Response
	err = i.gnmiDeleteSubscriberUeImsiWildcard(context.Background(), "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard", target, id)
	...
	log.Infof("DeleteSubscriberUeImsiWildcard")
	return ctx.JSON(http.StatusOK, response)
}

// GetSubscriberUeImsiWildcard impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard
func (i *ServerImpl) GetSubscriberUeImsiWildcard(ctx echo.Context, target types.Target, id string) error {

	var response interface{}
	var err error

	// Response GET OK 200
	response, err = i.gnmiGetSubscriberUeImsiWildcard(context.Background(), "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard", target, id)
	...
	log.Infof("GetSubscriberUeImsiWildcard")
	return ctx.JSON(http.StatusOK, response)
}

// PostSubscriberUeImsiWildcard impl of gNMI access at /aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard
func (i *ServerImpl) PostSubscriberUeImsiWildcard(ctx echo.Context, target types.Target, id string) error {
	...
	extension100, err := i.gnmiPostSubscriberUeImsiWildcard(context.Background(), body, "/aether/v2.0.0/{target}/subscriber/ue/{id}/imsi/wildcard", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
	...
	log.Infof("PostSubscriberUeImsiWildcard")
	return ctx.JSON(http.StatusOK, response)
}
