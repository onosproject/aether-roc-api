...
import (
	...
	externalRef0 "github.com/onosproject/aether-roc-api/pkg/aether_5_0_0/types"
	"github.com/onosproject/aether-roc-api/pkg/southbound"
	"github.com/onosproject/aether-roc-api/pkg/utils"
	externalRef1 "github.com/onosproject/config-models/modelplugin/aether-5.0.0/aether_5_0_0"
...
// DeleteApplication impl of gNMI access at /aether/v5.0.0/{target}/application
func (i *ServerImpl) DeleteApplication(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteApplication(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application", target)
	if err == nil {
...
// GetApplication impl of gNMI access at /aether/v5.0.0/{target}/application
func (i *ServerImpl) GetApplication(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetApplication(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application", target)
...
// PostApplication impl of gNMI access at /aether/v5.0.0/{target}/application
func (i *ServerImpl) PostApplication(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostApplication(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/application", target)
	if err == nil {
...
// DeleteApplicationApplication impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}
func (i *ServerImpl) DeleteApplicationApplication(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteApplicationApplication(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application/application/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetApplicationApplication impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}
func (i *ServerImpl) GetApplicationApplication(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetApplicationApplication(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application/application/{id}", target, id)
...
// PostApplicationApplication impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}
func (i *ServerImpl) PostApplicationApplication(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostApplicationApplication(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/application/application/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteApplicationApplicationEndpoint impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}
func (i *ServerImpl) DeleteApplicationApplicationEndpoint(ctx echo.Context, target externalRef0.Target, id string, endpointId string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteApplicationApplicationEndpoint(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}", target, id, endpointId)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetApplicationApplicationEndpoint impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}
func (i *ServerImpl) GetApplicationApplicationEndpoint(ctx echo.Context, target externalRef0.Target, id string, endpointId string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetApplicationApplicationEndpoint(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}", target, id, endpointId)
...
// PostApplicationApplicationEndpoint impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}
func (i *ServerImpl) PostApplicationApplicationEndpoint(ctx echo.Context, target externalRef0.Target, id string, endpointId string) error {
	...
	extension100, err := i.gnmiPostApplicationApplicationEndpoint(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}", target, id, endpointId)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteApplicationApplicationEndpointMbr impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}/mbr
func (i *ServerImpl) DeleteApplicationApplicationEndpointMbr(ctx echo.Context, target externalRef0.Target, id string, endpointId string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteApplicationApplicationEndpointMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}/mbr", target, id, endpointId)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetApplicationApplicationEndpointMbr impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}/mbr
func (i *ServerImpl) GetApplicationApplicationEndpointMbr(ctx echo.Context, target externalRef0.Target, id string, endpointId string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetApplicationApplicationEndpointMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}/mbr", target, id, endpointId)
...
// PostApplicationApplicationEndpointMbr impl of gNMI access at /aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}/mbr
func (i *ServerImpl) PostApplicationApplicationEndpointMbr(ctx echo.Context, target externalRef0.Target, id string, endpointId string) error {
	...
	extension100, err := i.gnmiPostApplicationApplicationEndpointMbr(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/application/application/{id}/endpoint/{endpoint-id}/mbr", target, id, endpointId)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/connectivity-service
func (i *ServerImpl) DeleteConnectivityService(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteConnectivityService(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/connectivity-service", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/connectivity-service
func (i *ServerImpl) GetConnectivityService(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetConnectivityService(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/connectivity-service", target)
...
// PostConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/connectivity-service
func (i *ServerImpl) PostConnectivityService(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostConnectivityService(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/connectivity-service", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteConnectivityServiceConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/connectivity-service/connectivity-service/{id}
func (i *ServerImpl) DeleteConnectivityServiceConnectivityService(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteConnectivityServiceConnectivityService(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/connectivity-service/connectivity-service/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetConnectivityServiceConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/connectivity-service/connectivity-service/{id}
func (i *ServerImpl) GetConnectivityServiceConnectivityService(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetConnectivityServiceConnectivityService(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/connectivity-service/connectivity-service/{id}", target, id)
...
// PostConnectivityServiceConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/connectivity-service/connectivity-service/{id}
func (i *ServerImpl) PostConnectivityServiceConnectivityService(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostConnectivityServiceConnectivityService(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/connectivity-service/connectivity-service/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/device-group
func (i *ServerImpl) DeleteDeviceGroup(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteDeviceGroup(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/device-group
func (i *ServerImpl) GetDeviceGroup(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetDeviceGroup(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group", target)
...
// PostDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/device-group
func (i *ServerImpl) PostDeviceGroup(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostDeviceGroup(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/device-group", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteDeviceGroupDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}
func (i *ServerImpl) DeleteDeviceGroupDeviceGroup(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteDeviceGroupDeviceGroup(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetDeviceGroupDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}
func (i *ServerImpl) GetDeviceGroupDeviceGroup(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetDeviceGroupDeviceGroup(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}", target, id)
...
// PostDeviceGroupDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}
func (i *ServerImpl) PostDeviceGroupDeviceGroup(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostDeviceGroupDeviceGroup(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/device-group/device-group/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteDeviceGroupDeviceGroupDevice impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/device
func (i *ServerImpl) DeleteDeviceGroupDeviceGroupDevice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteDeviceGroupDeviceGroupDevice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}/device", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetDeviceGroupDeviceGroupDevice impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/device
func (i *ServerImpl) GetDeviceGroupDeviceGroupDevice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetDeviceGroupDeviceGroupDevice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}/device", target, id)
...
// PostDeviceGroupDeviceGroupDevice impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/device
func (i *ServerImpl) PostDeviceGroupDeviceGroupDevice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostDeviceGroupDeviceGroupDevice(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/device-group/device-group/{id}/device", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteDeviceGroupDeviceGroupDeviceMbr impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/device/mbr
func (i *ServerImpl) DeleteDeviceGroupDeviceGroupDeviceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteDeviceGroupDeviceGroupDeviceMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}/device/mbr", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetDeviceGroupDeviceGroupDeviceMbr impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/device/mbr
func (i *ServerImpl) GetDeviceGroupDeviceGroupDeviceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetDeviceGroupDeviceGroupDeviceMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}/device/mbr", target, id)
...
// PostDeviceGroupDeviceGroupDeviceMbr impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/device/mbr
func (i *ServerImpl) PostDeviceGroupDeviceGroupDeviceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostDeviceGroupDeviceGroupDeviceMbr(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/device-group/device-group/{id}/device/mbr", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteDeviceGroupDeviceGroupImsis impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/imsis/{imsi-id}
func (i *ServerImpl) DeleteDeviceGroupDeviceGroupImsis(ctx echo.Context, target externalRef0.Target, id string, imsiId string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteDeviceGroupDeviceGroupImsis(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}/imsis/{imsi-id}", target, id, imsiId)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetDeviceGroupDeviceGroupImsis impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/imsis/{imsi-id}
func (i *ServerImpl) GetDeviceGroupDeviceGroupImsis(ctx echo.Context, target externalRef0.Target, id string, imsiId string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetDeviceGroupDeviceGroupImsis(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/device-group/device-group/{id}/imsis/{imsi-id}", target, id, imsiId)
...
// PostDeviceGroupDeviceGroupImsis impl of gNMI access at /aether/v5.0.0/{target}/device-group/device-group/{id}/imsis/{imsi-id}
func (i *ServerImpl) PostDeviceGroupDeviceGroupImsis(ctx echo.Context, target externalRef0.Target, id string, imsiId string) error {
	...
	extension100, err := i.gnmiPostDeviceGroupDeviceGroupImsis(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/device-group/device-group/{id}/imsis/{imsi-id}", target, id, imsiId)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteEnterprise impl of gNMI access at /aether/v5.0.0/{target}/enterprise
func (i *ServerImpl) DeleteEnterprise(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteEnterprise(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/enterprise", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetEnterprise impl of gNMI access at /aether/v5.0.0/{target}/enterprise
func (i *ServerImpl) GetEnterprise(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetEnterprise(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/enterprise", target)
...
// PostEnterprise impl of gNMI access at /aether/v5.0.0/{target}/enterprise
func (i *ServerImpl) PostEnterprise(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostEnterprise(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/enterprise", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteEnterpriseEnterprise impl of gNMI access at /aether/v5.0.0/{target}/enterprise/enterprise/{id}
func (i *ServerImpl) DeleteEnterpriseEnterprise(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteEnterpriseEnterprise(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/enterprise/enterprise/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetEnterpriseEnterprise impl of gNMI access at /aether/v5.0.0/{target}/enterprise/enterprise/{id}
func (i *ServerImpl) GetEnterpriseEnterprise(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetEnterpriseEnterprise(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/enterprise/enterprise/{id}", target, id)
...
// PostEnterpriseEnterprise impl of gNMI access at /aether/v5.0.0/{target}/enterprise/enterprise/{id}
func (i *ServerImpl) PostEnterpriseEnterprise(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostEnterpriseEnterprise(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/enterprise/enterprise/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteEnterpriseEnterpriseConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/enterprise/enterprise/{id}/connectivity-service/{connectivity-service}
func (i *ServerImpl) DeleteEnterpriseEnterpriseConnectivityService(ctx echo.Context, target externalRef0.Target, id string, connectivityService string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteEnterpriseEnterpriseConnectivityService(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/enterprise/enterprise/{id}/connectivity-service/{connectivity-service}", target, id, connectivityService)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetEnterpriseEnterpriseConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/enterprise/enterprise/{id}/connectivity-service/{connectivity-service}
func (i *ServerImpl) GetEnterpriseEnterpriseConnectivityService(ctx echo.Context, target externalRef0.Target, id string, connectivityService string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetEnterpriseEnterpriseConnectivityService(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/enterprise/enterprise/{id}/connectivity-service/{connectivity-service}", target, id, connectivityService)
...
// PostEnterpriseEnterpriseConnectivityService impl of gNMI access at /aether/v5.0.0/{target}/enterprise/enterprise/{id}/connectivity-service/{connectivity-service}
func (i *ServerImpl) PostEnterpriseEnterpriseConnectivityService(ctx echo.Context, target externalRef0.Target, id string, connectivityService string) error {
	...
	extension100, err := i.gnmiPostEnterpriseEnterpriseConnectivityService(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/enterprise/enterprise/{id}/connectivity-service/{connectivity-service}", target, id, connectivityService)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteIpDomain impl of gNMI access at /aether/v5.0.0/{target}/ip-domain
func (i *ServerImpl) DeleteIpDomain(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteIpDomain(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/ip-domain", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetIpDomain impl of gNMI access at /aether/v5.0.0/{target}/ip-domain
func (i *ServerImpl) GetIpDomain(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetIpDomain(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/ip-domain", target)
...
// PostIpDomain impl of gNMI access at /aether/v5.0.0/{target}/ip-domain
func (i *ServerImpl) PostIpDomain(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostIpDomain(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/ip-domain", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteIpDomainIpDomain impl of gNMI access at /aether/v5.0.0/{target}/ip-domain/ip-domain/{id}
func (i *ServerImpl) DeleteIpDomainIpDomain(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteIpDomainIpDomain(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/ip-domain/ip-domain/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetIpDomainIpDomain impl of gNMI access at /aether/v5.0.0/{target}/ip-domain/ip-domain/{id}
func (i *ServerImpl) GetIpDomainIpDomain(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetIpDomainIpDomain(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/ip-domain/ip-domain/{id}", target, id)
...
// PostIpDomainIpDomain impl of gNMI access at /aether/v5.0.0/{target}/ip-domain/ip-domain/{id}
func (i *ServerImpl) PostIpDomainIpDomain(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostIpDomainIpDomain(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/ip-domain/ip-domain/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteSite impl of gNMI access at /aether/v5.0.0/{target}/site
func (i *ServerImpl) DeleteSite(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteSite(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetSite impl of gNMI access at /aether/v5.0.0/{target}/site
func (i *ServerImpl) GetSite(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetSite(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site", target)
...
// PostSite impl of gNMI access at /aether/v5.0.0/{target}/site
func (i *ServerImpl) PostSite(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostSite(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/site", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteSiteSite impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}
func (i *ServerImpl) DeleteSiteSite(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteSiteSite(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetSiteSite impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}
func (i *ServerImpl) GetSiteSite(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetSiteSite(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}", target, id)
...
// PostSiteSite impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}
func (i *ServerImpl) PostSiteSite(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostSiteSite(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/site/site/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteSiteSiteImsiDefinition impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/imsi-definition
func (i *ServerImpl) DeleteSiteSiteImsiDefinition(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteSiteSiteImsiDefinition(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/imsi-definition", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetSiteSiteImsiDefinition impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/imsi-definition
func (i *ServerImpl) GetSiteSiteImsiDefinition(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetSiteSiteImsiDefinition(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/imsi-definition", target, id)
...
// PostSiteSiteImsiDefinition impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/imsi-definition
func (i *ServerImpl) PostSiteSiteImsiDefinition(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostSiteSiteImsiDefinition(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/site/site/{id}/imsi-definition", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteSiteSiteMonitoring impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/monitoring
func (i *ServerImpl) DeleteSiteSiteMonitoring(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteSiteSiteMonitoring(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/monitoring", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetSiteSiteMonitoring impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/monitoring
func (i *ServerImpl) GetSiteSiteMonitoring(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetSiteSiteMonitoring(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/monitoring", target, id)
...
// PostSiteSiteMonitoring impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/monitoring
func (i *ServerImpl) PostSiteSiteMonitoring(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostSiteSiteMonitoring(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/site/site/{id}/monitoring", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteSiteSiteMonitoringEdgeDevice impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/monitoring/edge-device/{edge-device-id}
func (i *ServerImpl) DeleteSiteSiteMonitoringEdgeDevice(ctx echo.Context, target externalRef0.Target, id string, edgeDeviceId string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteSiteSiteMonitoringEdgeDevice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/monitoring/edge-device/{edge-device-id}", target, id, edgeDeviceId)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetSiteSiteMonitoringEdgeDevice impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/monitoring/edge-device/{edge-device-id}
func (i *ServerImpl) GetSiteSiteMonitoringEdgeDevice(ctx echo.Context, target externalRef0.Target, id string, edgeDeviceId string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetSiteSiteMonitoringEdgeDevice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/monitoring/edge-device/{edge-device-id}", target, id, edgeDeviceId)
...
// PostSiteSiteMonitoringEdgeDevice impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/monitoring/edge-device/{edge-device-id}
func (i *ServerImpl) PostSiteSiteMonitoringEdgeDevice(ctx echo.Context, target externalRef0.Target, id string, edgeDeviceId string) error {
	...
	extension100, err := i.gnmiPostSiteSiteMonitoringEdgeDevice(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/site/site/{id}/monitoring/edge-device/{edge-device-id}", target, id, edgeDeviceId)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteSiteSiteSmallCell impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/small-cell/{small-cell-id}
func (i *ServerImpl) DeleteSiteSiteSmallCell(ctx echo.Context, target externalRef0.Target, id string, smallCellId string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteSiteSiteSmallCell(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/small-cell/{small-cell-id}", target, id, smallCellId)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetSiteSiteSmallCell impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/small-cell/{small-cell-id}
func (i *ServerImpl) GetSiteSiteSmallCell(ctx echo.Context, target externalRef0.Target, id string, smallCellId string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetSiteSiteSmallCell(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/site/site/{id}/small-cell/{small-cell-id}", target, id, smallCellId)
...
// PostSiteSiteSmallCell impl of gNMI access at /aether/v5.0.0/{target}/site/site/{id}/small-cell/{small-cell-id}
func (i *ServerImpl) PostSiteSiteSmallCell(ctx echo.Context, target externalRef0.Target, id string, smallCellId string) error {
	...
	extension100, err := i.gnmiPostSiteSiteSmallCell(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/site/site/{id}/small-cell/{small-cell-id}", target, id, smallCellId)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteTemplate impl of gNMI access at /aether/v5.0.0/{target}/template
func (i *ServerImpl) DeleteTemplate(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteTemplate(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetTemplate impl of gNMI access at /aether/v5.0.0/{target}/template
func (i *ServerImpl) GetTemplate(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetTemplate(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template", target)
...
// PostTemplate impl of gNMI access at /aether/v5.0.0/{target}/template
func (i *ServerImpl) PostTemplate(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostTemplate(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/template", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteTemplateTemplate impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}
func (i *ServerImpl) DeleteTemplateTemplate(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteTemplateTemplate(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template/template/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetTemplateTemplate impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}
func (i *ServerImpl) GetTemplateTemplate(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetTemplateTemplate(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template/template/{id}", target, id)
...
// PostTemplateTemplate impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}
func (i *ServerImpl) PostTemplateTemplate(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostTemplateTemplate(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/template/template/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteTemplateTemplateSlice impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}/slice
func (i *ServerImpl) DeleteTemplateTemplateSlice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteTemplateTemplateSlice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template/template/{id}/slice", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetTemplateTemplateSlice impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}/slice
func (i *ServerImpl) GetTemplateTemplateSlice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetTemplateTemplateSlice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template/template/{id}/slice", target, id)
...
// PostTemplateTemplateSlice impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}/slice
func (i *ServerImpl) PostTemplateTemplateSlice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostTemplateTemplateSlice(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/template/template/{id}/slice", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteTemplateTemplateSliceMbr impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}/slice/mbr
func (i *ServerImpl) DeleteTemplateTemplateSliceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteTemplateTemplateSliceMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template/template/{id}/slice/mbr", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetTemplateTemplateSliceMbr impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}/slice/mbr
func (i *ServerImpl) GetTemplateTemplateSliceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetTemplateTemplateSliceMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/template/template/{id}/slice/mbr", target, id)
...
// PostTemplateTemplateSliceMbr impl of gNMI access at /aether/v5.0.0/{target}/template/template/{id}/slice/mbr
func (i *ServerImpl) PostTemplateTemplateSliceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostTemplateTemplateSliceMbr(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/template/template/{id}/slice/mbr", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteTrafficClass impl of gNMI access at /aether/v5.0.0/{target}/traffic-class
func (i *ServerImpl) DeleteTrafficClass(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteTrafficClass(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/traffic-class", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetTrafficClass impl of gNMI access at /aether/v5.0.0/{target}/traffic-class
func (i *ServerImpl) GetTrafficClass(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetTrafficClass(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/traffic-class", target)
...
// PostTrafficClass impl of gNMI access at /aether/v5.0.0/{target}/traffic-class
func (i *ServerImpl) PostTrafficClass(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostTrafficClass(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/traffic-class", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteTrafficClassTrafficClass impl of gNMI access at /aether/v5.0.0/{target}/traffic-class/traffic-class/{id}
func (i *ServerImpl) DeleteTrafficClassTrafficClass(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteTrafficClassTrafficClass(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/traffic-class/traffic-class/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetTrafficClassTrafficClass impl of gNMI access at /aether/v5.0.0/{target}/traffic-class/traffic-class/{id}
func (i *ServerImpl) GetTrafficClassTrafficClass(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetTrafficClassTrafficClass(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/traffic-class/traffic-class/{id}", target, id)
...
// PostTrafficClassTrafficClass impl of gNMI access at /aether/v5.0.0/{target}/traffic-class/traffic-class/{id}
func (i *ServerImpl) PostTrafficClassTrafficClass(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostTrafficClassTrafficClass(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/traffic-class/traffic-class/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteUpf impl of gNMI access at /aether/v5.0.0/{target}/upf
func (i *ServerImpl) DeleteUpf(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteUpf(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/upf", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetUpf impl of gNMI access at /aether/v5.0.0/{target}/upf
func (i *ServerImpl) GetUpf(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetUpf(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/upf", target)
...
// PostUpf impl of gNMI access at /aether/v5.0.0/{target}/upf
func (i *ServerImpl) PostUpf(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostUpf(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/upf", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteUpfUpf impl of gNMI access at /aether/v5.0.0/{target}/upf/upf/{id}
func (i *ServerImpl) DeleteUpfUpf(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteUpfUpf(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/upf/upf/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetUpfUpf impl of gNMI access at /aether/v5.0.0/{target}/upf/upf/{id}
func (i *ServerImpl) GetUpfUpf(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetUpfUpf(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/upf/upf/{id}", target, id)
...
// PostUpfUpf impl of gNMI access at /aether/v5.0.0/{target}/upf/upf/{id}
func (i *ServerImpl) PostUpfUpf(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostUpfUpf(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/upf/upf/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteVcs impl of gNMI access at /aether/v5.0.0/{target}/vcs
func (i *ServerImpl) DeleteVcs(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response
	extension100, err := i.gnmiDeleteVcs(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs", target)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetVcs impl of gNMI access at /aether/v5.0.0/{target}/vcs
func (i *ServerImpl) GetVcs(ctx echo.Context, target externalRef0.Target) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetVcs(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs", target)
...
// PostVcs impl of gNMI access at /aether/v5.0.0/{target}/vcs
func (i *ServerImpl) PostVcs(ctx echo.Context, target externalRef0.Target) error {
	...
	extension100, err := i.gnmiPostVcs(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/vcs", target)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteVcsVcs impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}
func (i *ServerImpl) DeleteVcsVcs(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteVcsVcs(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetVcsVcs impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}
func (i *ServerImpl) GetVcsVcs(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetVcsVcs(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}", target, id)
...
// PostVcsVcs impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}
func (i *ServerImpl) PostVcsVcs(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostVcsVcs(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/vcs/vcs/{id}", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteVcsVcsDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/device-group/{device-group}
func (i *ServerImpl) DeleteVcsVcsDeviceGroup(ctx echo.Context, target externalRef0.Target, id string, deviceGroup string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteVcsVcsDeviceGroup(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/device-group/{device-group}", target, id, deviceGroup)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetVcsVcsDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/device-group/{device-group}
func (i *ServerImpl) GetVcsVcsDeviceGroup(ctx echo.Context, target externalRef0.Target, id string, deviceGroup string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetVcsVcsDeviceGroup(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/device-group/{device-group}", target, id, deviceGroup)
...
// PostVcsVcsDeviceGroup impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/device-group/{device-group}
func (i *ServerImpl) PostVcsVcsDeviceGroup(ctx echo.Context, target externalRef0.Target, id string, deviceGroup string) error {
	...
	extension100, err := i.gnmiPostVcsVcsDeviceGroup(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/vcs/vcs/{id}/device-group/{device-group}", target, id, deviceGroup)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteVcsVcsFilter impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/filter/{application}
func (i *ServerImpl) DeleteVcsVcsFilter(ctx echo.Context, target externalRef0.Target, id string, application string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteVcsVcsFilter(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/filter/{application}", target, id, application)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetVcsVcsFilter impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/filter/{application}
func (i *ServerImpl) GetVcsVcsFilter(ctx echo.Context, target externalRef0.Target, id string, application string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetVcsVcsFilter(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/filter/{application}", target, id, application)
...
// PostVcsVcsFilter impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/filter/{application}
func (i *ServerImpl) PostVcsVcsFilter(ctx echo.Context, target externalRef0.Target, id string, application string) error {
	...
	extension100, err := i.gnmiPostVcsVcsFilter(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/vcs/vcs/{id}/filter/{application}", target, id, application)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteVcsVcsSlice impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/slice
func (i *ServerImpl) DeleteVcsVcsSlice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteVcsVcsSlice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/slice", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetVcsVcsSlice impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/slice
func (i *ServerImpl) GetVcsVcsSlice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetVcsVcsSlice(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/slice", target, id)
...
// PostVcsVcsSlice impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/slice
func (i *ServerImpl) PostVcsVcsSlice(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostVcsVcsSlice(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/vcs/vcs/{id}/slice", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
...
// DeleteVcsVcsSliceMbr impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/slice/mbr
func (i *ServerImpl) DeleteVcsVcsSliceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response
	extension100, err := i.gnmiDeleteVcsVcsSliceMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/slice/mbr", target, id)
	if err == nil {
		log.Infof("Delete succeded %s", *extension100)
		return ctx.JSON(http.StatusOK, extension100)
	}
...
// GetVcsVcsSliceMbr impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/slice/mbr
func (i *ServerImpl) GetVcsVcsSliceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	// Response GET OK 200
	response, err = i.gnmiGetVcsVcsSliceMbr(utils.NewGnmiContext(ctx), "/aether/v5.0.0/{target}/vcs/vcs/{id}/slice/mbr", target, id)
...
// PostVcsVcsSliceMbr impl of gNMI access at /aether/v5.0.0/{target}/vcs/vcs/{id}/slice/mbr
func (i *ServerImpl) PostVcsVcsSliceMbr(ctx echo.Context, target externalRef0.Target, id string) error {
	...
	extension100, err := i.gnmiPostVcsVcsSliceMbr(utils.NewGnmiContext(ctx), body, "/aether/v5.0.0/{target}/vcs/vcs/{id}/slice/mbr", target, id)
	if err == nil {
		log.Infof("Post succeded %s", *extension100)
		return ctx.JSON(http.StatusCreated, extension100)
	}
