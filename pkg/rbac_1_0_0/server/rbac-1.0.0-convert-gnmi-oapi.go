...
func (d *ModelPluginDevice) toRbac(params ...string) (*types.Rbac, error) {
	...
	//Property: { group {[]RbacGroup  0xc0000c7000 map[] [] false <nil> [] false} false false}
	// Handle []Object
	...
	//Property: { role {[]RbacRole  0xc0000c7080 map[] [] false <nil> [] false} false false}
	// Handle []Object
...
func (d *ModelPluginDevice) toRbacGroup(params ...string) (*types.RbacGroup, error) {
	...
	//Property: { role {[]RbacGroupRole  0xc0000c7200 map[] [] false <nil> [] false} false false}
	// Handle []Object
...
func (d *ModelPluginDevice) toRbacRolePermission(params ...string) (*types.RbacRolePermission, error) {
	...
	//Property: { leaf-list-noun {[]string  0xc0000c7680 map[] [] false <nil> [] false} false false}
	//Leaf list handling
