...
func EncodeToGnmiRbac(
	...
	//Property: { group {[]RbacGroup  0xc00027fe00 map[] [] false <nil> [] false} false false}
	if jsonObj.Group != nil {

	}
	//Property: { role {[]RbacRole  0xc00027fe80 map[] [] false <nil> [] false} false false}
	if jsonObj.Role != nil {
...
func EncodeToGnmiRbacGroup(
	...
	//Property: { role {[]RbacGroupRole  0xc00038a000 map[] [] false <nil> [] false} false false}
	if jsonObj.Role != nil {
...
func EncodeToGnmiRbacRolePermission(
	...
	//Property: { leaf-list-noun {[]string  0xc00038a480 map[] [] false <nil> [] false} false false}
