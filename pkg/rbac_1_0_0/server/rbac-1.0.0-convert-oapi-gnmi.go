...
func EncodeToGnmiRbac(
	...
	//Property: { Group {[]RbacGroup  0xc000390b00 map[] [] false <nil> [] false} false false}
	if jsonObj.Group != nil {

	}
	//Property: { Role {[]RbacRole  0xc000390b80 map[] [] false <nil> [] false} false false}
	if jsonObj.Role != nil {
...
func EncodeToGnmiRbacGroup(
	...
	//Property: { Role {[]RbacGroupRole  0xc000390d00 map[] [] false <nil> [] false} false false}
	if jsonObj.Role != nil {
...
func EncodeToGnmiRbacRolePermission(
	...
	//Property: { leaf-list-noun {[]string  0xc000391180 map[] [] false <nil> [] false} false false}
